...
class PieChartTransaction extends CustomPainter {
  static double cbdc_amount = 150;
  static double cash_amount = 50;
  PieChartTransaction({@required this.categories, @required this.width});
...
final kCategories = [
  ...
  Category('CASH', amount: PieChartTransaction.cash_amount),
  Category('CBDC', amount: PieChartTransaction.cbdc_amount),
];
